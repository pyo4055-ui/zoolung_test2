...
function fitOnePage(doc){
  ...
  const scale=Math.max(.42,Math.min(1,targetW/w,targetH/h));
...
function standaloneTodayPrint(){
  ...
  doc.write(`<!doctype html><html lang="ko"><head><meta charset="utf-8"><title>오늘 운영${dateTitle?' - '+dateTitle:''}</title>${styleMarkup()}<style>
    ...
    *{box-sizing:border-box!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}
    ...
    body{font-family:-apple-system,BlinkMacSystemFont,"Noto Sans KR",sans-serif!important;color:#1f2a23!important}
    ...
    #tab-today .zr-today-main,#tab-today .zr-today-program,#tab-today .zr-today-views{padding:2mm!important}
    ...
    #tab-today .zr-today-label{font-size:5pt!important;margin-bottom:1mm!important}#tab-today .zr-today-program-grid{grid-template-columns:1fr 1fr!important;gap:1mm!important}#tab-today .zr-today-program-grid>div{padding:1.2mm!important;border-radius:1.5mm!important}#tab-today .zr-today-program-grid b{font-size:5pt!important}#tab-today .zr-today-program-grid span{font-size:5.2pt!important}
    #tab-today .zr-today-check-grid{gap:1mm!important}#tab-today .zr-today-check{padding:1.1mm!important;border-radius:1.5mm!important}#tab-today .zr-today-check b,#tab-today .zr-today-check span{font-size:5.2pt!important}
