...
need(admin.includes('admin_shell_submenus_v1.js?v=2'),'admin entry must load sidebar section submenus after the main shell.');
...
for(const required of [
  ...
  "label:'아웃소싱 업체 설정'",
  "label:'예약 확정 문자'",
  "targetId:'zrActivityMainSubtabV1'",
  "targetId:'zrActivityCancelSubtabV1'",
...
console.log('OK: sidebar owns activity cancellation, preview-visit and existing nested subtabs, switches hidden original controls without default-tab flash, preserves delayed hover/multi-open behavior, and performs no data writes.');
