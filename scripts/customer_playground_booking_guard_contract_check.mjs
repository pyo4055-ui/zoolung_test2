...
for(const needle of [
  ...
  '현재 예약 가능 현황상 이 입장시간은 최대 30분 이용 가능합니다.',
  '60분 이용을 원하시면 다른 놀이터 입장시간을 선택해주세요.',
...
ok('customer playground booking order and duration guidance are isolated and write-free');
