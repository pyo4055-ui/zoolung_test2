...
function injectStyle(){
  ...
  html.zr-customer-entry-v2{
    ...
    --zr-v2-line:#e3d8d0;
    --zr-v2-close-bg:#fff;
    --zr-v2-close-bg-hover:#fff7ef;
    --zr-v2-close-line:#eaded5;
    --zr-v2-close-text:#470910;
  }
  ...
  .zr-guide-v2-close{min-width:54px;min-height:36px;border:1px solid rgba(71,9,16,.18);border-radius:9px;background:#fff;color:var(--zr-v2-wine);font-weight:900;cursor:pointer}
  ...
  .zr-guide-v2-actions{display:flex;justify-content:flex-end;gap:9px;padding:0 20px 20px}
  .zr-guide-v2-actions button{min-height:48px;border-radius:11px;font-size:14px;font-weight:900;cursor:pointer}
  #zrCustomerGroupGuideOkV2{min-width:180px;border:1px solid var(--zr-v2-orange);background:var(--zr-v2-orange);color:#fff}
  ...
  @media(max-width:520px){
    ...
    .zr-guide-v2-body{padding:16px}.zr-guide-v2-actions{padding:0 16px 16px}.zr-guide-v2-item{grid-template-columns:1fr;gap:4px}
  }
...
function ensureGuideModal(){
  ...
  modal.innerHTML=`<div class="zr-guide-v2-sheet">
    ...
    <div class="zr-guide-v2-actions"><button type="button" id="zrCustomerGroupGuideOkV2">확인</button></div>
  </div>`;
