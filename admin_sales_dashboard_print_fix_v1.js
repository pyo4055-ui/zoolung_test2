...
function fitOnePage(doc){
  ...
  const scale=Math.max(.52,Math.min(1,targetH/h));
...
function standalonePrint(){
  ...
  doc.open();doc.write(`<!doctype html><html lang="ko"><head><meta charset="utf-8"><title>${title}</title>${styleMarkup()}<style>
    ...
    *{box-sizing:border-box!important;-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}
    ...
    body{padding:3mm 12mm 3mm 3mm!important;font-family:-apple-system,BlinkMacSystemFont,"Noto Sans KR",sans-serif!important;color:#2f2b28!important}
    #zrSalesPrintSheet{transform-origin:top left!important;width:250mm!important;max-width:250mm!important;margin:0!important;padding:0!important}
    #tab-sales-dashboard{display:block!important;width:250mm!important;max-width:250mm!important;min-width:0!important;margin:0!important;padding:0!important;background:#fff!important;overflow:visible!important}
    #tab-sales-dashboard .zr-sales-print-title{font-size:17pt!important;font-weight:950!important;margin:0 0 2.5mm!important;color:#2f2b28!important}
    #tab-sales-dashboard .zr-sales-subtitle,#tab-sales-dashboard .zr-sales-subtabs,#zrSalesPrintBtn{display:none!important}
    #tab-sales-dashboard .zr-sales-panel{display:block!important;width:250mm!important;max-width:250mm!important;min-width:0!important;overflow:visible!important}
    ...
    #tab-sales-dashboard .zr-sales-filter label,#tab-sales-dashboard .zr-sales-revisit-yearbox{min-width:31mm!important;padding:1.6mm!important;border:1px solid #ddd6d0!important;border-radius:1.6mm!important;background:#fff!important}
    ...
    #tab-sales-dashboard .zr-sales-kpi{min-width:0!important;min-height:0!important;padding:2mm!important;border:1px solid #ddd8d3!important;border-radius:1.8mm!important;background:#fff!important;box-shadow:none!important;overflow:hidden!important}
    ...
    #tab-sales-dashboard .zr-sales-card{min-width:0!important;max-width:100%!important;width:auto!important;padding:2.1mm!important;border:1px solid #ddd8d3!important;border-radius:1.8mm!important;background:#fff!important;box-shadow:none!important;overflow:hidden!important;break-inside:avoid!important}
    ...
    #tab-sales-dashboard .zr-sales-daily-card{min-width:0!important;max-width:100%!important;padding:1.6mm!important;border-color:#ddd8d3!important;overflow:hidden!important}
...
function replaceExistingPrintAction(){
  const btn=$('zrSalesPrintBtn');if(!btn||btn.dataset.zrStandalonePrintV1==='3')return !!btn;btn.dataset.zrStandalonePrintV1='3';
